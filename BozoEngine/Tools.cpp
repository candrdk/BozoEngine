	...
	VkPipelineStageFlags dstStageMask) 
{
	...
	case VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL: barrier.srcAccessMask = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT; break;
	...
	switch (newLayout) {
	case VK_IMAGE_LAYOUT_PRESENT_SRC_KHR: barrier.dstAccessMask = 0; break;
	...
	case VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL: barrier.dstAccessMask = VK_ACCESS_DEPTH_STENCIL_ATTACHMENT_WRITE_BIT; break;
